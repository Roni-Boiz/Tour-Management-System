...
public class GuideDTO {
    ...
    public GuideDTO(String gidID, String fName, String lName, String NIC, String Address, int YOE, String mobileNo, String email, String vehicle, String guideLicence) {
        this.gidID = gidID;
        this.fName = fName;
        this.lName = lName;
        this.NIC = NIC;
